// Conversion automatique de camera-recorder (Vue.js vers JavaScript natif)
...
// Gestion de l'état
let currentCamera = cameras.value[0]?.deviceId;
let currentMicrophone = microphones.value[0]?.deviceId;
let permissionCannotBePrompted = false;
